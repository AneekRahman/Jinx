...
import app.jinx.com.Classes.PostButtonBounceInterpolator;
import app.jinx.com.Classes.RegularPost;
import app.jinx.com.HomeFragment;
...
public class RegularPostAdapter extends RecyclerView.Adapter<RegularPostAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setMainHolderHeight(){
            ...
            int adjustedHeight = (height / 7) * 5;

            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, adjustedHeight);
